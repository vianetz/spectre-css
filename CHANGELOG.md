...
- support for Dart Sass @use at-rules
- Github Actions for build and docs deployment
- support for Dependabot
- check for bundlesize

### Changed 

- replaced `scss-lint` with `stylelint` (for correct Dart Sass support)
- updated HighlightJs version in docs

### Fixed

- updated dependencies to make gulp work again
